...
public class Insurance {
    ...
    public static void main(String[] args) {
        ...
        Map<Character, List<Policy>> groupedByInitial = groupInitialStream
        ...
        Map<String, Double> numberToPremiumMap = policyMapStream
                .collect(Collectors.toMap(p -> p.number, p -> p.premium));
        ...
        Stream<Map.Entry<String, Long>> sortedFrequencyEntries = frequencyEntryStream
